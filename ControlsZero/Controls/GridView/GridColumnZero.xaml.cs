...
public partial class GridColumnZero : ContentView
{
    ...
    CustomScrollView scrollView => GetScrollView(this);

    private static CustomScrollView GetScrollView(Element target)
    {
        if (target.Parent is CustomScrollView csv)
            return csv;
        if (target.Parent is null)
            return null;
        return GetScrollView(target.Parent);
    }
    ...
    public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(nameof(ItemsSource), typeof(IList), typeof(GridColumnZero), null, BindingMode.OneWay, null, ItemsSourceChanged);
    ...
    public static readonly BindableProperty RemainingItemsProperty = BindableProperty.Create(nameof(RemainingItems), typeof(int), typeof(GridColumnZero), -1, BindingMode.OneWay, null, RemainingItemsChanged);
    ...
    public static readonly BindableProperty RemainingItemsChangedCommandProperty = BindableProperty.Create(nameof(RemainingItemsChangedCommand), typeof(ICommand), typeof(GridColumnZero), null, BindingMode.OneWay, null, RemainingItemsChangedCommandChanged);
    ...
    public static readonly BindableProperty SelectedItemsProperty = BindableProperty.Create(nameof(SelectedItems), typeof(IList), typeof(GridColumnZero), null, BindingMode.TwoWay, null, SelectedItemsChanged);
    ...
    public static readonly BindableProperty SelectionModeProperty = BindableProperty.Create(nameof(SelectionMode), typeof(SelectionMode), typeof(GridColumnZero), SelectionMode.None, BindingMode.OneWay, null, SelectionModeChanged);
    ...
    public static readonly BindableProperty SelectedItemProperty = BindableProperty.Create(nameof(SelectedItem), typeof(object), typeof(GridColumnZero), null, BindingMode.TwoWay, null, SelectedItemChanged);
    ...
    public static readonly BindableProperty ScrollOffsetProperty = BindableProperty.Create(nameof(ScrollOffset), typeof(double), typeof(GridColumnZero), (double)0.0, BindingMode.TwoWay, null, ScrollOffsetChanged, null/*, CoerceScrollOffsetValue*/);
    ...
    public static readonly BindableProperty ItemHeightProperty = BindableProperty.Create(nameof(ItemHeight), typeof(double), typeof(GridColumnZero), (double)40.0, BindingMode.OneWay);
