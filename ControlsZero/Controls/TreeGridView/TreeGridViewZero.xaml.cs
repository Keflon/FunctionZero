...
public partial class TreeGridViewZero
{
    ...
    public static readonly BindableProperty ColumnsSourceProperty = BindableProperty.Create(nameof(ColumnsSource), typeof(IList<GridColumnZero>), typeof(TreeGridViewZero), null, BindingMode.OneWay, null, ColumnsSourceChanged);

    private static void ColumnsSourceChanged(BindableObject bindable, object oldValue, object newValue)
    {
        var self = (TreeGridViewZero)bindable;
    ...
    {
        // TODO: Force TheGrid to reflect ColumnsSource whilst retaining the tree-view in column 0.
        // TODO: For now, just brute-force it.
        //BatchBegin();

        while (TheGridView.ColumnsSource.Count > 1)
            TheGridView.ColumnsSource.RemoveAt(1);

        if (ColumnsSource != null)
            foreach (var column in ColumnsSource)
            {
                column.ControlTemplate = columnControlTemplate;
                TheGridView.ColumnsSource.Add(column);
            }
        //BatchCommit();
    }

    public static readonly BindableProperty ItemHeightProperty = BindableProperty.Create(nameof(ItemHeight), typeof(float), typeof(TreeGridViewZero), (float)30.0, BindingMode.OneWay, null);
    ...
    public static readonly BindableProperty ScrollOffsetProperty = BindableProperty.Create(nameof(ScrollOffset), typeof(float), typeof(TreeGridViewZero), (float)0.0, BindingMode.OneWay, null, null, ScrollOffsetChanged);
    ...
    public static readonly BindableProperty SelectedItemProperty = BindableProperty.Create(nameof(SelectedItem), typeof(object), typeof(TreeGridViewZero), null, BindingMode.TwoWay, null, SelectedItemChanged);
    ...
    public static readonly BindableProperty SelectedItemsProperty = BindableProperty.Create(nameof(SelectedItems), typeof(IList), typeof(TreeGridViewZero), null, BindingMode.TwoWay, null, SelectedItemsChanged);
    ...
    public static readonly BindableProperty SelectionModeProperty = BindableProperty.Create(nameof(SelectionMode), typeof(SelectionMode), typeof(TreeGridViewZero), SelectionMode.None, BindingMode.TwoWay, null, SelectionModeChanged);
    ...
    public static readonly BindableProperty TreeItemTemplateProperty = BindableProperty.Create("TreeItemTemplate", typeof(TemplateProvider), typeof(TreeGridViewZero), null, propertyChanged: OnItemTemplateChanged);
    ...
    {
        var self = bindable as TreeGridViewZero;
    }

    public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create("ItemsSource", typeof(object), typeof(TreeGridViewZero), null, propertyChanged: OnItemsSourceChanged);
    ...
    private static void OnItemsSourceChanged(BindableObject bindable, object oldValue, object newValue)
    {
        ...
        if (newValue != null)
        {
            ...
            ((INotifyCollectionChanged)self._rootContainer.TreeNodeChildren).CollectionChanged += TreeGridViewZero_CollectionChanged;
            self.OnPropertyChanged(nameof(TreeChildren));
        }
    }

    public static readonly BindableProperty IsRootVisibleProperty = BindableProperty.Create(nameof(IsRootVisible), typeof(bool), typeof(TreeGridViewZero), true, propertyChanged: OnIsRootVisibleChanged);
    ...
    public static readonly BindableProperty TreeItemControlTemplateProperty = BindableProperty.Create("TreeItemControlTemplate", typeof(ControlTemplate), typeof(TreeGridViewZero), null, propertyChanged: OnTreeItemControlTemplateChanged);
    ...
    public static readonly BindableProperty IndentMultiplierProperty = BindableProperty.Create("IndentMultiplier", typeof(double), typeof(TreeGridViewZero), 15D);
    ...
    public static readonly BindableProperty ItemContainerStyleProperty = BindableProperty.Create(nameof(ItemContainerStyle), typeof(Style), typeof(TreeGridViewZero), null, BindingMode.OneWay, null, ItemContainerStyleChanged);
    ...
    private static void TreeGridViewZero_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
    {
